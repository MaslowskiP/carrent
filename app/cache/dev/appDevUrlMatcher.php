...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'defalut_homepage');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'defalut_homepage',);
        }

        // lista
        if ($pathinfo === '/lista') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::listaAction',  '_route' => 'lista',);
        }
